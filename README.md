...
- #### [🏗 시스템 아키텍처](#🏗-시스템-아키텍처)
- #### [🔗 협업 & 문서](#🔗-협업-&-문서)
- #### [📱 서비스 화면](https://github.com/pirogramming/Healthtant?tab=readme-ov-file#-%EC%84%9C%EB%B9%84%EC%8A%A4-%ED%99%94%EB%A9%B4)
...
- 📝 [Flow Chart](https://drive.google.com/file/d/1fOryk0bAjHYsW8XG56HVSzIAIEUrqrLo/view?usp=sharing)
...
| **일반 검색(음식 추천)** | **일반 검색 페이지 (검색 전)** | **일반 검색 페이지 (검색 후)** |
| :------: |  :------: | :------: |
...
* 식품을 검색하여 찾은 뒤 등록할 수 있습니다.

| **식사 기록** | **식품 검색 전** | **식품 검색 후** | **음식 선택 후** |
| :------: |  :------: | :------: |  :------: |
